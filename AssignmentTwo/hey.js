...
const redGeometry = new THREE.BoxGeometry(3, 3, 3)
// Cube Materials
...
{
    const redCube = new THREE.Mesh(redGeometry, material)
    cube.position.x = i - 10
    cube.position.z = (Math.random() - 0.5) * 10
    cube.position.y = (Math.random() - 0.5) * 10
...
{
    if (term == uiobj.term3 || uiobj.term2)
